	...
	<div class="container">
		<div class="row">
			<div class="col-md-8 offset-md-2">
				...
				<hr>
				<form method="post"
					action="<%=request.getContextPath()%>/admin/programa/save">
					...
					<div class="form-group">
						<label class="control-label">Nombre</label> <input type="text"
							name="nombre" class="form-control" value="${programa.nombre}">
					</div>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								<label class="control-label">Código</label> <input type="text"
									name="codigo" class="form-control" value="${programa.codigo}">
							</div>
						</div>
						...
						<div class="form-group text-center mt-4">
							<a class="btn btn-link"
								href="<%=request.getContextPath()%>/admin/programa">Cancelar</a>
